...
INSERT INTO GATEWAY_CONFIGURATIONS(KEY, VALUE, GATEWAY_FK ) VALUES ('base_url', 'https://test.oppwa.com', ( SELECT UUID FROM GATEWAYS WHERE NAME = 'SIBS'));
INSERT INTO GATEWAY_CONFIGURATIONS(KEY, VALUE, GATEWAY_FK ) VALUES ('entity_id', '8a8294185332bbe601533754724914d9', ( SELECT UUID FROM GATEWAYS WHERE NAME = 'SIBS'));
INSERT INTO GATEWAY_CONFIGURATIONS(KEY, VALUE, GATEWAY_FK ) VALUES ('token', 'OGE4Mjk0MTg1MzMyYmJlNjAxNTMzNzU0NzZjMzE1Mjd8RzV3UDVUekY1aw==', ( SELECT UUID FROM GATEWAYS WHERE NAME = 'SIBS'));
